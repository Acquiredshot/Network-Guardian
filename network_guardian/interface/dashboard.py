...
class Dashboard:
    ...
    def _route(self, path: str) -> str:
        ...
        # Dynamic fleet agent detail route
    ...
    async def _ctrl_cloaking_start(self, data: dict) -> str:
        await self.engine.cloaking.start()
        return self._json_response({"ok": True, "message": "Cloaking started"})
    ...
    def _api_fleet_agent(self, path: str) -> str:
        agent_id = path.split("/api/fleet/agent/", 1)[-1]
