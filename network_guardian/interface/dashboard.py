...
class Dashboard:
    ...
    def _page_incidents(self) -> str:
        ...
        html = (
            ...
            'background:var(--surface);border:1px solid var(--border);font-size:.82rem;transition:.15s}'
            '.nav a:hover,.nav a.active{background:#1f6feb22;color:var(--blue);border-color:var(--blue)}'
            '.ir-card{background:var(--surface);border:1px solid var(--border);border-radius:10px;'
            'margin-bottom:16px;overflow:hidden}'
            '.ir-header{display:flex;align-items:center;gap:12px;padding:14px 18px;cursor:pointer;'
            'border-bottom:1px solid var(--border)}'
            '.ir-header:hover{background:#ffffff08}'
            ...
            '.ir-md h1{font-size:1.15rem;font-weight:700;color:var(--blue);margin:0 0 12px}'
            ...
            '.ir-md th,.ir-md td{padding:6px 10px;border:1px solid var(--border);text-align:left}'
            '.ir-md th{background:#ffffff08;font-weight:600;color:var(--dim)}'
            '.ir-md code{background:#ffffff10;padding:1px 5px;border-radius:3px;'
            'font-family:ui-monospace,monospace;font-size:.82rem}'
            '.ir-md hr{border:none;border-top:1px solid var(--border);margin:16px 0}'
            ...
            '.sev-medium{background:#d2992220;color:var(--yellow)}'
            '.sev-low{background:#3fb95020;color:var(--green)}'
            '.dl-btn{padding:5px 12px;border-radius:6px;border:1px solid var(--border);'
            'background:var(--surface);color:var(--blue);cursor:pointer;font-size:.78rem;margin-left:auto}'
            '.dl-btn:hover{background:#58a6ff20}'
            '.empty{color:var(--dim);padding:30px;text-align:center}'
            '#ts{margin-left:auto;color:var(--dim);font-size:.85rem}'
            '</style></head><body>'
            '<div class="wrap">'
